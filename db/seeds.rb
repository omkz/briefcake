...
FactoryBot.create(:feed, "name": "Marques Brownlee - YouTube", "url": "https://www.youtube.com/channel/UCBJycsmduvYEL83R_U4JriQ", "user_id": user.id, "rss_feed_url": "https://www.youtube.com/feeds/videos.xml?channel_id=UCBJycsmduvYEL83R_U4JriQ", "publish_date_last_sent_item": 14.days.ago, "truncation": nil)
FactoryBot.create(:feed, :with_fetch_error, "name": "Example", "url": "https://www.example.com", "user_id": user.id, "rss_feed_url": "https://www.youtube.com/feeds/videos.xml?channel_id=UCBJycsmduvYEL83R_U4JriQ", "publish_date_last_sent_item": 14.days.ago, "truncation": nil)
