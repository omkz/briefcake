...
FactoryBot.create(:feed, "name": "Timo Kuilder", "url": "https://www.instagram.com/zwartekoffie/", "user_id": user.id, "feed_url": nil, "publish_date_last_sent_item": 10.days.ago)
...
FactoryBot.create(:feed, :with_fetch_error, "name": "Example", "url": "https://www.example.com", "user_id": user.id, "feed_url": "https://www.youtube.com/feeds/videos.xml?channel_id=UCBJycsmduvYEL83R_U4JriQ", "publish_date_last_sent_item": 14.days.ago, "truncation": nil)
